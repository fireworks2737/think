<?php if (!defined('THINK_PATH')) exit();?>        <div class="result-wrap">
            <form action="/ceshi1/index.php/Admin/Programs/more_delete" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/ceshi1/index.php/Admin/Programs/insert" style="font-size:12px;color:black;"><i class="icon-font"></i>新增文件</a>
                ...
                <div class="result-content" >
                    <table class="result-tab" width="62%" >
						...
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/ceshi1/index.php/Admin/Programs/update/id/<?php echo ($v["id"]); ?>">修改</a>
                                <a class="link-del" href="/ceshi1/index.php/Admin/Programs/delete/id/<?php echo ($v["id"]); ?>" >删除</a>
                            </td>
